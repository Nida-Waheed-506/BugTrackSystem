...
const addProjectFunc = async (req, res, next) => {
    ...
    try {
        ...
        if (project) res.json({ message: "Project added successfully", data: project });
...
const getProjectsFunc = async (req, res, next) => {
    ...
    try {
        ...
        if (projects) res.json({ message: "Projects get successfully", data: projects });
...
const updateProjectFunc = async (req, res, next) => {
    ...
    try {
        ...
        const project = await updateProject(projectId , manager_id.toString(), req.body);
     
        if (project) res.json({ message: "Project updated successfully", data: project });
...
module.exports = { addProjectFunc, getProjectsFunc, updateProjectFunc, deleteProjectFunc };